...
public class Home extends JFrame {
	...
	public Home() {
		...
		show.setIcon(new ImageIcon("C:\\Users\\Avishkar Kumbhar\\eclipse-workspace\\Internet Banking\\Images\\eye.png"));
		...
		login.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if (user.equals("Avishkar") &&  pass.equals("Jai Hind")) {
